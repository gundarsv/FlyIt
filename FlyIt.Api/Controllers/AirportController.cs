...
namespace FlyIt.Api.Controllers
{
    ...
    public class AirportController : ControllerBase
    {
        ...
        {
            var result = await airportService.AddAirport(airport.Iata, airport.Name, airport.MapUrl, airport.MapName, airport.RentingCompanyUrl, airport.RentingCompanyName, airport.RentingCompanyPhoneNo, User);
        ...
        {
            var result = await airportService.UpdateAirport(id, airport.Iata, airport.Name, airport.MapUrl, airport.MapName, airport.RentingCompanyUrl, airport.RentingCompanyName, airport.RentingCompanyPhoneNo, User);
