...
namespace FlyIt.DataAccess.Migrations
{
    ...
    [Migration("20201124112229_add_chat_entities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlyIt.DataAccess.Entities.Chatroom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FlyIt.DataAccess.Entities.ChatroomMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FlyIt.DataAccess.Entities.UserChatroom", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FlyIt.DataAccess.Entities.Chatroom", b =>
                {
                    b.HasOne("FlyIt.DataAccess.Entities.Flight", "Flight")
                        .WithOne()
                        .HasForeignKey("FlyIt.DataAccess.Entities.Chatroom", "FlightId")
            ...
            modelBuilder.Entity("FlyIt.DataAccess.Entities.ChatroomMessage", b =>
                {
                    b.HasOne("FlyIt.DataAccess.Entities.Chatroom", "Chatroom")
