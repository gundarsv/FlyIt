    ...
    public class AirportServiceTest
    {
        ...
        public class AddAirport : AirportServiceTest
        {
            ...
            public async Task ReturnsNotFoundIfUserNotFound()
            {
                ...
                var result = await airportService.AddAirport(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<ClaimsPrincipal>());
        ...
        public class UpdateAirport : AirportServiceTest
        {
            ...
            public async Task ReturnsNotFoundIfUserNotFound()
            {
                ...
                var result = await airportService.UpdateAirport(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<ClaimsPrincipal>());
