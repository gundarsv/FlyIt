    ...
    public class FlightMapping : Profile
    {
        public FlightMapping()
        {
            ...
            CreateMap<Entity.Flight, FlightDTO>()
                ...
                .ForMember(fdto => fdto.ChatroomId, options => options.MapFrom(f => f.Chatroom.Id))
                .ForMember(fdto => fdto.LastUpdated, options => options.MapFrom(f => f.LastUpdated))
            ...
            CreateMap<Entity.UserFlight, FlightDTO>()
                ...
                .ForMember(fdto => fdto.ChatroomId, options => options.MapFrom(f => f.Flight.Chatroom.Id))
                .ForMember(fdto => fdto.LastUpdated, options => options.MapFrom(f => f.Flight.LastUpdated))
