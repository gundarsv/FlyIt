...
namespace FlyIt.Domain.Services
{
    public interface IAirportService
    {
        ...
        public Task<Result<AirportDTO>> AddAirport(string Iata, string Name, string MapUrl, string MapName, string RentingCompanyUrl, string RentingCompanyName, string RentingCompanyPhoneNo, string Icao, ClaimsPrincipal claims);

        public Task<Result<AirportDTO>> DeleteAirport(int id, ClaimsPrincipal claims);

        public Task<Result<AirportDTO>> UpdateAirport(int id, string Iata, string Name, string MapUrl, string MapName, string RentingCompanyUrl, string RentingCompanyName, string RentingCompanyPhoneNo, string Icao, ClaimsPrincipal claims);
    }
}